        ...
        <form action="{{ route('admin.pokedex.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="name" id="name" aria-describedby="helpname"
                    value="{{ old('name') }}" placeholder="Add a new Pokemon Name">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="type_1" id="type_1" aria-describedby="helptype_1"
                    value="{{ old('type_1') }}" placeholder="Add a new Pokemon type_1">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="type_2" id="type_2" aria-describedby="helptype_2"
                    value="{{ old('type_2') }}" placeholder="Add a new Pokemon type_2">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="hp" id="hp" aria-describedby="helphp"
                    value="{{ old('hp') }}" placeholder="Add a new Pokemon hp">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="attack" id="attack" aria-describedby="helpattack"
                    value="{{ old('attack') }}" placeholder="Add a new Pokemon attack">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="defense" id="defense" aria-describedby="helpdefense"
                    value="{{ old('defense') }}" placeholder="Add a new Pokemon defense">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="speed" id="speed" aria-describedby="helpspeed"
                    value="{{ old('speed') }}" placeholder="Add a new Pokemon speed">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="special" id="special" aria-describedby="helpspecial"
                    value="{{ old('special') }}" placeholder="Add a new Pokemon special">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="gif" id="gif" aria-describedby="helpgif"
                    value="{{ old('gif') }}" placeholder="Add a new Pokemon gif">
                <small id="helpgif" class="form-text text-muted">Add a image path</small>
            </div>
            <div class="mb-3">
                <label for="description" class="form-label">Description</label>
                <textarea name="description" id="description" class="form-control w-100" value="{{ old('description') }}"
                    rows="5"></textarea>
